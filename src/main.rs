...
use bevy::{
    image::{ImageLoaderSettings, ImageAddressMode},
    camera::ScalingMode,
    prelude::*,
...
fn startup(
    ...
    animations.insert("float_up".to_string(),Animation{
        start: 16,
        end : 16,
        frame_duration : default_frame_duration,
        looping : true,
    });
    animations.insert("fall".to_string(),Animation{
        start: 17,
        end : 22,
        frame_duration : default_frame_duration,
        looping : false,
    });
    animations.insert("float_down".to_string(),Animation{
        start: 23,
        end : 23,
        frame_duration : default_frame_duration,
        looping : true,
    });
    animations.insert("land".to_string(),Animation{
        start: 24,
        end : 27,
        frame_duration : default_frame_duration,
        looping : false,
